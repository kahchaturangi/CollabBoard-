...
export default function Login({ setIsAuthenticated, setBoardId }) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#0a0c10', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ backgroundColor: '#14171d', padding: '40px', borderRadius: '16px', width: '100%', maxWidth: '440px', border: '1px solid #1f232b', boxShadow: '0 12px 40px rgba(0,0,0,0.5)' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <h2 style={{ color: '#ffffff', margin: '0 0 8px 0', fontSize: '24px', fontWeight: '700' }}>Welcome Back!</h2>
          <p style={{ color: '#8a919e', margin: 0, fontSize: '15px' }}>Please log in to your account.</p>
        </div>
          ...
          <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <input
                ...
                style={{ marginRight: '10px', width: '16px', height: '16px', accentColor: '#5c5cfc', cursor: 'pointer', backgroundColor: '#1c2028', border: '1px solid #262933' }}
              />
              <label htmlFor="rememberMe" style={{ color: '#8a919e', fontSize: '14px', cursor: 'pointer' }}>Remember me</label>
            </div>
            <a href="#" style={{ color: '#5c5cfc', textDecoration: 'none', fontSize: '14px' }}>Forgot Password?</a>
          </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <Link to="/register" style={{ color: '#5c5cfc', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>
            Create an Account
          </Link>
        </div>
